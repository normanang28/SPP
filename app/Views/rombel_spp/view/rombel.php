...
<?php if(session()->get('level')== 1) { ?>
        ...
        <th class="text-center">Rombel Name</th>
...
<?php if(session()->get('level')== 1) { ?>
                      ...
                      <td class="text-uppercase text-center"><?php echo $gas->nama_rombel?></td>
...
<div class="button-container">
                        <a href="<?= base_url('/home/edit_rombel/'.$gas->id_rombel)?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> </button></a>
                        <a href="<?= base_url('/home/delete_rombel/'.$gas->id_rombel)?>"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a>
</div>
<style>
    .button-container {
    display: flex;
...
function displayDataOnPage(page) {
    ...
    for (let i = startIndex; i < endIndex && i < data.length; i++) {
        ...
        <tr>
            ...
            <td class="text-uppercase text-center text-dark">${gas.nama_rombel}</td>
            <td class="text-capitalize text-center text-dark">${gas.nama_guru}</td>
