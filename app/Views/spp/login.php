...
<head>
	...
	<!-- <title>Login - Sekolah Permata Harapanku</title> -->
	...
	<div class="wrapper">
		<form method="post" action="<?= base_url('home/aksi_login') ?>">
			...
			<!-- <div class="input-box">
                ...
                <input for="captcha" type="text" class="form-control" id="captcha" name="captcha_answer" placeholder="What is <?php echo $num1 ?> + <?php echo $num2 ?>?" required>
