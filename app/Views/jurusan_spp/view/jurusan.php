...
<?php if(session()->get('level')== 1) { ?>
            <a href="<?= base_url('/home/add_major/')?>"><button class="btn btn-success"><i class="fa fa-plus"></i> Add</button></a>
<?php }else{} ?>
...
<?php if(session()->get('level')== 1) { ?>
                      ...
                      <td class="text-uppercase text-center"><?php echo $gas->nama_jurusan?></td>
                      <td class="text-capitalize text-center"><?php echo $gas->jurusan_lengkap?></td>
                      <td class="text-capitalize text-center"><?php echo $gas->username?></td>      
                      <td>
<div class="button-container">
                        <a href="<?= base_url('/home/edit_major/'.$gas->id_jurusan)?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> </button></a>
                        <a href="<?= base_url('/home/delete_major/'.$gas->id_jurusan)?>"><button class="btn btn-danger"><i class="fa fa-trash"></i> </button></a>
</div>
                      </td>
                        <?php }else{} ?>
                        </tr>
...
function displayDataOnPage(page) {
    ...
    for (let i = startIndex; i < endIndex && i < data.length; i++) {
        ...
        <tr>
            ...
            <td class="text-uppercase text-center text-dark">${gas.nama_jurusan}</td>
            <td class="text-capitalize text-center text-dark">${gas.jurusan_lengkap}</td>
