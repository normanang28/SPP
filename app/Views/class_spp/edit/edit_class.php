    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
                <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_edit_class')?>" method="post">
                        ...
                        <div class="item form-group">
                            <label class="form-label">Class Name<span style="color: red;">*</span></label>
                                <div class="col-12">
                                  ...
                                  <option value="<?= $duar->nama_kelas?>"><?= $duar->nama_kelas; ?></option>
