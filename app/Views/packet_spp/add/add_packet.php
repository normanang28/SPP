    ...
    <div class="card">
        <div class="card-body">
            <div class="basic-form">
              <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_add_packet')?>" method="post">

                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label class="form-label">Packet Name<span style="color: red;">*</span></label>
                            <input type="text" id="nama_paket" name="nama_paket" 
                            class="form-control text-uppercase" placeholder="Packet Name">
                        </div>
                        <div class="mb-3 col-md-6">
