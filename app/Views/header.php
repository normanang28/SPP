...
<head>
	...
	<meta name="format-detection" content="telephone=no">
		...
		<!-- <title>SPP - Sekolah Permata Harapanku</title> -->
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									<div class="header-info">
										<!-- <span>Hello, <strong class="text-capitalize"><?= session()->get('nama_guru')?></strong></span> -->
...
<?php  if(session()->get('level')== 1 || session()->get('level')== 2 || session()->get('level')== 4) { ?>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?= base_url('/home/profile')?>" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" title="Profile"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ms-2">Profile </span title="Profile">
                                    </a>
<?php }else{} ?>
<?php  if(session()->get('level')== 3) { ?>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?= base_url('/home/profile_students')?>" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" title="Profile"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ms-2">Profile </span title="Profile">
                                    </a>
<?php }else{} ?>
                                    <a href="<?= base_url('/home/change_pw')?>" class="dropdown-item ai-icon">
                                        <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" title="Change Password"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                        <span class="ms-2">Change Password </span title="Change Password">
                                    </a>
                                    ...
                                    <a href="<?= base_url('/home/log_out')?>" class="dropdown-item ai-icon">
                                        <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" title="Logout"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                        <span class="ms-2">Logout </span title="Change Password">
                                    </a>
                                </div>
                            </li>
                        </ul>
